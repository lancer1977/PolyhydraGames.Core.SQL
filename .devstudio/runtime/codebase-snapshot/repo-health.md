...
Generated: `2026-06-23T17:09:47.777956+00:00`
Model lane: `auto`
Preparedness input: `/mnt/data/lancer1977/code/Core.SQL/.devstudio/runtime/codebase-snapshot/preparedness.json`

- Scope roots: `/mnt/data/lancer1977/code/Core.SQL`
...
## Top recommendations
- `/mnt/data/lancer1977/code/Core.SQL` — readiness `82` / priority `50`
  ...
  - Dependency status: `warn`
    - `dotnet` manifests: `samples/Core.SQL.Smoke/Core.SQL.Smoke.csproj, src/PolyhydraGames.Data.Sql.csproj, tests/Core.SQL.Tests/Core.SQL.Tests.csproj`
